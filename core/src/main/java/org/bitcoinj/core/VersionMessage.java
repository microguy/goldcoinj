...
public class VersionMessage extends Message {
    ...
    public static final String BITCOINJ_VERSION = "0.14.10";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/goldcoinj:" + BITCOINJ_VERSION + "/";
     ...
     * else. For example, calling <code>appendToSubVer("MultiBit", "1.0", "Windows")</code> will result in a subVer being
